...
import com.iris.agent.zwave.code.entity.CmdAssocReport;

@Id(AssociationCmdClass.CMD_ASSOCIATION_REPORT)
@Name("Assocation Report")
public class AssocReportCmd extends AbstractCmd {

   @Override
   public Decoder getDecoder() {
      return CmdAssocReport.DECODER;
   }
