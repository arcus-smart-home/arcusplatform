 ...
 *
 */
public class CmdAssocGroupingsGet extends AbstractZCmd {
   private final static int BYTE_LENGTH = 2;

   public CmdAssocGroupingsGet() {
      super(CmdClasses.ASSOCIATION.intId(), AssociationCmdClass.CMD_ASSOCIATION_GROUPINGS_GET, BYTE_LENGTH);
   }
