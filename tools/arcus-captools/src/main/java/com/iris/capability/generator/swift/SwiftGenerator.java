...
public class SwiftGenerator {
   public final static Logger logger = LoggerFactory.getLogger(SwiftGenerator.class);
   ...
   public static class Arguments {
      ...
      @Parameter(names={ "-o", "--output"}, description="Output path for capability and service Swift files", arity=1, required=true)
   ...
   private static void generateSource(String template, String output, List<Definition> definitions) throws Exception {
      SwiftProcessor processor = new SwiftProcessor(template, output);
