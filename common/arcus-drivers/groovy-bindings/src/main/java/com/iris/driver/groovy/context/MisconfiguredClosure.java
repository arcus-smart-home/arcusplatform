...
public class MisconfiguredClosure extends Closure<Object> {

   public MisconfiguredClosure(Object owner) {
      super(owner);
   }
   ...
   protected void doCall(String message) {
      ...
      errors.put(DeviceAdvancedCapability.PairingMisconfiguredException.CODE_PAIRING_MISCONFIGURED, message);
