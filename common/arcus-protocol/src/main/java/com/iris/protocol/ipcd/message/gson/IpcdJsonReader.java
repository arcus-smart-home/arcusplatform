...
package com.iris.protocol.ipcd.message.gson;
...
/**
 * Modification to address issue #494 about commas in a map generated errors during lenient.
 * Modifications by Hans Harmon
 ...
 * <a href="http://en.wikipedia.org/wiki/JSON#Cross-site_request_forgery">Cross-
 * site request forgery</a> attacks. In such an attack, a malicious site gains
 * access to a private JSON file by executing it with an HTML {@code <script>}
 * tag.
 *
 * <p>
 ...
 * @since 1.6
 */
public class IpcdJsonReader extends JsonReader {
    ...
    * that array. Otherwise the value is undefined, and we take advantage of
    * that by incrementing pathIndices when doing so isn't useful.
    */
    ...
    */
   public IpcdJsonReader(Reader in) {
      super(in);
...
// End Modification - HPH
         ...
         default:
            throw new IllegalStateException("JsonReader unknown Scope");
      }
   ...
   /**
    * Returns the {@link com.google.gson.stream.JsonToken#BOOLEAN boolean} value
   ...
   private int nextNonWhitespace(boolean throwOnEof) throws IOException {
      ...
      while (true) {
         ...
         if (c == '/') {
             ...
             * this behaviour, but it's required to parse existing documents.
             * See http://b/2571423.
             */
            checkLenient();
            skipToEndOfLine();
