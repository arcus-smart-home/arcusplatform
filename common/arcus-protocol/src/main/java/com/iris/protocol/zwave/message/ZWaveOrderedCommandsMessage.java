...
public class ZWaveOrderedCommandsMessage implements ZWaveMessage {
   private static final long serialVersionUID = 9007518570270140392L;

   public final static String TYPE = "OrderedCommand";

   private final List<ZWaveMessage> commands;
   private final ZWaveNode node;

   public ZWaveOrderedCommandsMessage(ZWaveNode node, List<ZWaveMessage> commands) {
      this.node = node;
   ...
   public String toString() {
      return "ZWaveOrderedCommandMessage [commands=" + commands + ", node=" + node + "]";
   }
