...
public class AttributeGreaterThanEqualToPredicate implements Predicate<Model>, Serializable {
   private static final org.slf4j.Logger log = LoggerFactory.getLogger(AttributeGreaterThanEqualToPredicate.class); // Where to log information and debuggin strings.

   private final String                  attributeName;
   private final Number                  attributeValue;

   public AttributeGreaterThanEqualToPredicate(String attributeName, Object attributeValue) {
   ...
   public boolean equals(Object obj) {
      ...
      if (getClass() != obj.getClass())
         return false;
      AttributeGreaterThanEqualToPredicate other = (AttributeGreaterThanEqualToPredicate) obj;
   ...
   public String toString() {
      return attributeName + " is greater than or equal to " + attributeValue;
   }
}
