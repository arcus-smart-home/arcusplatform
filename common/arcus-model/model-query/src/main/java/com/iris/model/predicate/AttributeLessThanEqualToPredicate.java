...
public class AttributeLessThanEqualToPredicate implements Predicate<Model>, Serializable {
   private static final org.slf4j.Logger log = LoggerFactory.getLogger(AttributeLessThanEqualToPredicate.class); // Where to log information and debuggin strings.

   private final String attributeName;
   private final Number attributeValue;

   public AttributeLessThanEqualToPredicate(String attributeName, Object attributeValue) {
   ...
   public boolean equals(Object obj) {
      ...
      if (getClass() != obj.getClass())
         return false;
      AttributeLessThanEqualToPredicate other = (AttributeLessThanEqualToPredicate) obj;
   ...
   public String toString() {
      return attributeName + " is less than or equal to " + attributeValue;
   }
}
