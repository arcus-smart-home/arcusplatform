 ...
 * 
 */
public class AttributeSupportedPredicate implements Predicate<Model>, Serializable {
   private final String attributeName;

   public AttributeSupportedPredicate(String attributeName) {
   ...
   public String toString() {
      return attributeName + " is supported";
   }
   ...
   public boolean equals(Object obj) {
      ...
      AttributeSupportedPredicate other = (AttributeSupportedPredicate) obj;
