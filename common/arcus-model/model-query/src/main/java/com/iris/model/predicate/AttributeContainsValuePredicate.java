 ...
 * 
 */
public class AttributeContainsValuePredicate implements Predicate<Model>, Serializable {
   private final String attributeName;
   private final Object attributeValue;

   public AttributeContainsValuePredicate(String attributeName, Object attributeValue) {
   ...
   public boolean apply(Model model) {
      ...
      if(!((Map<?, ?>) value).containsValue(attributeValue)) {
         // TODO logger
         return false;
      }
   ...
   public String toString() {
      return attributeName + " contains value " + attributeValue;
   }
   ...
   public boolean equals(Object obj) {
      ...
      AttributeContainsValuePredicate other = (AttributeContainsValuePredicate) obj;
