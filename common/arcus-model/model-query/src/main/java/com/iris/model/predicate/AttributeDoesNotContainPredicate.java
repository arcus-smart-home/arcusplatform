 ...
 * 
 */
public class AttributeDoesNotContainPredicate implements Predicate<Model>, Serializable {
   private final String attributeName;
   private final Object attributeValue;

   public AttributeDoesNotContainPredicate(String attributeName, Object attributeValue) {
   ...
   public String toString() {
      return attributeName + " does not contain " + attributeValue;
   }
   ...
   public boolean equals(Object obj) {
      ...
      AttributeDoesNotContainPredicate other = (AttributeDoesNotContainPredicate) obj;
