...
public class AttributeLessThanPredicate implements Predicate<Model>, Serializable {
   private static final org.slf4j.Logger log = LoggerFactory.getLogger(AttributeLessThanPredicate.class); // Where to log information and debuggin strings.

   private final String attributeName;
   private final Number attributeValue;

   public AttributeLessThanPredicate(String attributeName, Object attributeValue) {
   ...
   public boolean equals(Object obj) {
      ...
      if (getClass() != obj.getClass())
         return false;
      AttributeLessThanPredicate other = (AttributeLessThanPredicate) obj;
   ...
   public String toString() {
      return attributeName + " is less than " + attributeValue;
   }
}
