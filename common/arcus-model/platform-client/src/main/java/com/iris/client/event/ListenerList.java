 ...
 *
 */
// TODO ensure listeners are notified on the proper thread
public class ListenerList<T> {
   ...
   public <V extends T> ListenerRegistration addListener(final Class<V> type, final Listener<? super V> listener) {
