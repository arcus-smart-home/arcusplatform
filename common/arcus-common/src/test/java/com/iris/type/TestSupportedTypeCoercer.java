...
public class TestSupportedTypeCoercer extends TypeCoercerTestCase {
   ...
   public static Collection<Object[]> cases() {
      return Arrays.asList(new Object[][] {
            ...
            { String.class, TEST_STRING_ADDRESS, TEST_ADDRESS, "Address -> String" },
   ...
   public TestSupportedTypeCoercer(Class<?> target, Object expected, Object test, String name) {
      this.target = target;
   ...
   @Test
   public void testSupportedCoerce() throws Exception {
      System.out.println("Test coerce " + test.getClass().getName() + " to " + expected.getClass().getName());
      testSupported(target, expected, test);
   }
}
