...
public class DeviceOTAFirmwareURLBuilder implements FirmwareURLBuilder<String> {
   ...
   @Override
   public String buildURL(String productId, String firmwareTarget) {
      Preconditions.checkNotNull(productId, "The productId must not be null.");
      Preconditions.checkNotNull(firmwareTarget, "The firmwareTarget must not be null.");
      if (startsWithAny(firmwareTarget, "http://", "https://")) {
