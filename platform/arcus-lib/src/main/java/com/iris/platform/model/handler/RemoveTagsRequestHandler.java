...
@Singleton
public class RemoveTagsRequestHandler {

	@Request(RemoveTagsRequest.NAME)
	public void addTags(PersistentModelWrapper<? extends PersistentModel> wrapper, @Named(RemoveTagsRequest.ATTR_TAGS) Set<String> tags) {
