...
// TODO reconcile this with rule.ActionTemplate
public interface ActionResolver {
   
   String getId();

   ActionTemplate resolve(ActionContext context);
   
   Action generate(ActionContext context, Address target, Map<String, Object> variables);
}
