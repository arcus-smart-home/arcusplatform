...
public class GetTemperatureReadingResponse implements ResponsePayload {

   private DoubleValue temperatureReading;
   private String applianceResponseTimestamp;

   @Override
   public String getNamespace() { return QUERY_NAMESPACE; }

   public DoubleValue getTemperatureReading() {
      return temperatureReading;
   }

   public void setTemperatureReading(DoubleValue temperatureReading) {
