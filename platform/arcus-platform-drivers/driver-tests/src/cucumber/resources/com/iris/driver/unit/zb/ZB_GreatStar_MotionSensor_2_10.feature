@Zigbee @GreatStar @Motion @Reflex
Feature: Test of the GreatStar Motion Sensor ZigBee reflex driver
    
    These scenarios test the functionality of the GreatStar Motion Sensor ZigBee driver.

    Background:
    	Given the ZB_GreatStar_MotionSensor_2_10.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform.
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            And the message's base:caps attribute list should be [ 'base', 'dev', 'devadv', 'devconn', 'devpow', 'humid', 'mot', 'temp', 'devota', 'ident' ]
            And the message's dev:devtypehint attribute should be Motion
            And the message's devadv:drivername attribute should be ZBGreatStarMotionSensor 
...
############################################################
    ...
    Scenario Outline: Power Read / Report
        ...
        Examples:
          ...
          | zclreadattributesresponse | 21      | 0       | below min should be 0   |
          | zclreadattributesresponse | 25      | 0       |                         |
          | zclreportattributes       | 27      | 40      |                         |
