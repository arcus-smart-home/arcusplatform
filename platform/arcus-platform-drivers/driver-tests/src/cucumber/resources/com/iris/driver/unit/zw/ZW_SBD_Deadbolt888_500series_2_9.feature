@ZWave @lock @DoorLock @Kwikset @888 @plus
Feature: ZWave Stanley Black & Decker Deadbolt Driver Test

    These scenarios test the functionality of the Z-Wave Stanley Black & Decker (Kwikset) 888 5-Button Deadbolt, 500 Series

    Background:
        Given the ZW_SBD_Deadbolt888_500series_2_9.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform. 
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            ...
            And the message's devadv:drivername attribute should be ZWSBDDeadbolt888ZwavePlus 
