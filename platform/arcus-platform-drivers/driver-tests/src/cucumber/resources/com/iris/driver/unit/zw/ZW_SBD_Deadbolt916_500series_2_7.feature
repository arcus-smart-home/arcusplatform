@ZWave @lock @DoorLock @Kwikset @916 @plus
Feature: ZWave Stanley Black & Decker Deadbolt Driver Test

    These scenarios test the functionality of the Z-Wave Stanley Black & Decker (Kwikset) 916 Touchscreen Deadbolt, 500 Series

    Background:
        Given the ZW_SBD_Deadbolt916_500series_2_7.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform. 
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            ...
            And the message's devadv:drivername attribute should be ZWSBDDeadbolt916ZwavePlus 
