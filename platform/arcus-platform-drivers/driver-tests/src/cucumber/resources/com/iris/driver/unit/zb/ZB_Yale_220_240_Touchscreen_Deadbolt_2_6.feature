@Zigbee @DoorLock @Yale @TouchScreen @Deadbolt
Feature: Test of the Yale Real Living 220/240 Touch Screen Deadbolt ZigBee driver

    These scenarios test the functionality of the Yale Real Living 220/240 Touch Screen Deadbolt ZigBee driver.

    Background:
        Given the ZB_Yale_220_240_Touchscreen_Deadbolt_2_6.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform.
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            ...
            And the message's devadv:drivername attribute should be ZBYale220_240TouchscreenDeadbolt 
...
############################################################
    ...
    Scenario Outline: Power Read / Report
        ...
        When the device response with power <messageType> 
            And with parameter ATTR_BATTERY_VOLTAGE_PERCENT_REMAINING <vPcnt>
            And send to driver
    ...
    Examples:
      | messageType               | vPcnt   | battery |
      | zclreadattributesresponse | 0       | 0       |
      | zclreadattributesresponse | 10      | 10      |
      | zclreportattributes       | 50      | 50      |
      | zclreportattributes       | 100     | 100     |
      | zclreportattributes       | 101     | 100     |
