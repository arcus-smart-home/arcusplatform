@Zigbee @DoorLock @Yale @TouchScreen @LeverLock
Feature: Test of the Yale Real Living 220 Touch Screen Lever Lock ZigBee driver

    These scenarios test the functionality of the Yale Real Living 220 Touch Screen Lever Lock ZigBee driver.

    Background:
        Given the ZB_Yale_220_Touchscreen_Leverlock_2_6.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform.
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            ...
            And the message's devadv:drivername attribute should be ZBYale220TouchscreenLeverlock 
