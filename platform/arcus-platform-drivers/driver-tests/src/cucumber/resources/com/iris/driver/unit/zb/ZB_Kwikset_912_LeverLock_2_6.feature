@Zigbee @DoorLock @Kwikset @LeverLock
Feature: Test of the Kwikset SmartCode 912 5-Button Lever Lock ZigBee driver

    These scenarios test the functionality of the Kwikset SmartCode 912 5-Button Lever Lock ZigBee driver.

    Background:
        Given the ZB_Kwikset_912_LeverLock_2_6.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform.
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            ...
            And the message's devadv:drivername attribute should be ZBKwikset912LeverLock 
