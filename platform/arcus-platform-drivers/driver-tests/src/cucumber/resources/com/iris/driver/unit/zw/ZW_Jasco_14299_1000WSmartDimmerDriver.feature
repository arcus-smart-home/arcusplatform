@ZWave @Jasco500 @Dimmer @Jasco14299
Feature: Unit Tests Binary for the ZW_Jasco_14299_1000W_Dimmer_2_9

    These scenarios test the functionality of the 500 series Jasco 14299 1000W In-wall Dimmer driver

    Background:
        Given the ZW_Jasco_14299_1000W_Dimmer_2_9.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform. 
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            ...
            And the message's devadv:drivername attribute should be ZWJasco14299DimmerDriver
