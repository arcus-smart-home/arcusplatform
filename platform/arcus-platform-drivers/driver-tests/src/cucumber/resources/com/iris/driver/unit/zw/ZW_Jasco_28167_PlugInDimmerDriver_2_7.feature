@ZWave @Jasco500 @Dimmer @PlugIn @Jasco28167
Feature: Unit Tests Binary for the ZWJasco28167DimmerDriver

    These scenarios test the functionality of the 500 series Jasco Plug-In Dimmer driver

    Background:
        Given the ZW_Jasco_28167_PlugInDimmer_2_7.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform. 
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            ...
            And the message's devadv:drivername attribute should be ZWJasco28167DimmerDriver
