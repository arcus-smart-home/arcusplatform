@ZWave @Jasco500 @Dimmer @Jasco26933
Feature: Unit Tests Binary for the ZW_Jasco_26933_InWallPIRMotionDimmer_2_10 driver

    These scenarios test the functionality of the Jasco In-wall PIR Motion Dimmer driver

    Background:
        Given the ZW_Jasco_26933_InWallPIRMotionDimmer_2_10.driver has been initialized

    @basic
    Scenario: Driver reports capabilities to platform. 
        When a base:GetAttributes command is placed on the platform bus
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            And the message's base:caps attribute list should be ['base', 'dev', 'devadv', 'devpow', 'devconn', 'swit', 'dim', 'mot' ]
            And the message's dev:devtypehint attribute should be Dimmer
            And the message's devadv:drivername attribute should be ZWJasco26933DimmerDriver
