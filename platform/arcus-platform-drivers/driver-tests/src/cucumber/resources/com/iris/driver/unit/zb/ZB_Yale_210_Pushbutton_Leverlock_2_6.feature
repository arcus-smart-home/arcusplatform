@Zigbee @DoorLock @Yale @PushButton @LeverLock
Feature: Test of the Yale Real Living 210 Push Button Lever Lock ZigBee driver

    These scenarios test the functionality of the Yale Real Living 210 Push Button Lever Lock ZigBee driver.

    Background:
        Given the ZB_Yale_210_Pushbutton_Leverlock_2_6.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform.
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            ...
            And the message's devadv:drivername attribute should be ZBYale210PushbuttonLeverlock 
