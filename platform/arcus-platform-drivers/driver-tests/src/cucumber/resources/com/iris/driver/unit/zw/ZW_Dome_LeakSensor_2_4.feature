@ZWave @Dome @leak
Feature: ZWave Dome Leak Sensor Driver Test

These scenarios test the functionality of the ZWave Dome Leak Sensor driver

    Background:
    Given the ZW_Dome_LeakSensor_2_4.driver has been initialized
    ...
    Then the driver should place a base:GetAttributesResponse message on the platform bus
        ...
        And the message's devadv:drivername attribute should be ZWaveDomeLeakSensorDriver 
...
############################################################
# Dome Leak Sensor Driver Specific Tests
############################################################
