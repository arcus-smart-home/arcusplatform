@Zigbee @Sylvania @dimmer @bulb
Feature: Test of the Sylvania Ultra iQ BR30 Dimmable Bulb driver
	
	These scenarios test the functionality of the Sylvania Ultra iQ BR30 Dimmable Bulb driver.

Background:
	Given the ZB_Sylvania_iQBR30_Bulb.driver has been initialized
...
Scenario: Driver reports capabilities to platform.
	...
	Then the driver should place a base:GetAttributesResponse message on the platform bus
		...
		And the message's devadv:drivername attribute should be ZBSylvaniaBR30Bulb 
