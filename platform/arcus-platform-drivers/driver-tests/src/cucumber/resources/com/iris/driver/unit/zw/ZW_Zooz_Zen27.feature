@ZWave @Zooz @dimmer
Feature: ZWave Zooz ZEN27 S2 Dimmer Driver Test

These scenarios test the functionality of the ZWave Zooz ZEN27 S2 Dimmer driver

    Background:
    Given the ZW_Zooz_Zen27.driver has been initialized
    ...
    Then the driver should place a base:GetAttributesResponse message on the platform bus
        ...
        And the message's devadv:drivername attribute should be ZWZoozZen27Driver
