...
Feature: Test of the Bosch Radion PIR Motion Sensor ZigBee reflex driver
    
    These scenarios test the functionality of the Bosch Radion PIR Motion Sensor ZigBee driver.

    Background:
        Given the ZB_Bosch_RadionMotionDetector_2_3.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform.
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            ...
            And the message's devadv:drivername attribute should be ZBBoschRadionPIRMotionDetector 
