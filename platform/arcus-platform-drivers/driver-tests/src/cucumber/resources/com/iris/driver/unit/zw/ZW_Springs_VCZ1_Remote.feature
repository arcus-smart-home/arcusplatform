@ZWave @Blinds 
Feature: ZWave Springs VC1 Remote Test

	These scenarios test the functionality of the ZWave Springs Virtual Cord Remote driver.
	
	Background:
		Given the ZW_Springs_VCZ1_Remote.driver has been initialized
    ...
    Then the driver should place a base:GetAttributesResponse message on the platform bus
	    ...
	    And the message's devadv:drivername attribute should be ZWSpringsVCZ1RemoteDriver
