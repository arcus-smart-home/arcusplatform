@ZWave @Jasco500 @Dimmer @Jasco14294
Feature: Unit Tests Binary for the ZWJasco14294InWallDimmerDriver

    These scenarios test the functionality of the 500 series Jasco In-wall Dimmer driver

    Background:
        Given the ZW_Jasco_14294_InWallDimmer_2_7.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform. 
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            ...
            And the message's devadv:drivername attribute should be ZWJasco14294DimmerDriver
