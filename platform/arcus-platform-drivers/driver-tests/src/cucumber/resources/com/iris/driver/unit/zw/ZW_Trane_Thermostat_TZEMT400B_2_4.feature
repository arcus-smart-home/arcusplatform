@ZWave @therm24 @Trane
Feature: ZWave Trane Thermostat Driver Test

	These scenarios test the functionality of the ZWave Trane Thermostat driver.
	
	Background:
		Given the ZW_Trane_Thermostat_TZEMT400B_2_4.driver has been initialized
	
	Scenario: Driver reports capabilities to platform. 
	When a base:GetAttributes command is placed on the platform bus
	Then the driver should place a base:GetAttributesResponse message on the platform bus
		And the message's base:caps attribute list should be ['base', 'dev', 'devadv', 'devpow', 'devconn', 'temp','therm','humid', 'clock']
		And the message's dev:devtypehint attribute should be Thermostat
		And the message's devadv:drivername attribute should be ZWTraneThermostatTZEMT400B 
