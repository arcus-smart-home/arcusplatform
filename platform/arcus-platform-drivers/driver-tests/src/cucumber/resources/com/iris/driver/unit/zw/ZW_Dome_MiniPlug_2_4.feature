@ZWave @Dome @switch
Feature: ZWave Dome Mini Plug Driver Test

These scenarios test the functionality of the ZWave Dome Mini Plug driver

    Background:
    Given the ZW_Dome_MiniPlug_2_4.driver has been initialized
    ...
    Then the driver should place a base:GetAttributesResponse message on the platform bus
        ...
        And the message's devadv:drivername attribute should be ZWDomeMiniPlugDriver 
...
############################################################
# Dome Smart Plug Driver Specific Tests
############################################################
