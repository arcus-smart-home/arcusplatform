@ZWave @Dimmer @Generic
Feature: Unit Tests for ZWaveDimmer

	These scenarios test the functionality of the Generic Z-Wave Dimmer driver.

	Background:
		Given the ZW_ZZWaveGenericDimmer_2_11.driver has been initialized
	...
	Scenario: Driver reports capabilities to platform. 
		...
		Then the driver should place a base:GetAttributesResponse message on the platform bus
			...
			And the message's devadv:drivername attribute should be ZZWaveGenericDimmer
