@ZWave @Zooz @motion
Feature: ZWave Zooz Outdoor Motion Sensor Driver Test

These scenarios test the functionality of the ZWave Zooz ZSE29 Outdoor Motion Sensor driver

    Background:
    Given the ZW_Zooz_OutdoorMotionSensor_2_4.driver has been initialized
    ...
    Then the driver should place a base:GetAttributesResponse message on the platform bus
        ...
        And the message's devadv:drivername attribute should be ZWZoozOutdoorMotionSensorDriver
...
############################################################
# Motion Tests via sensor_binary report
############################################################
