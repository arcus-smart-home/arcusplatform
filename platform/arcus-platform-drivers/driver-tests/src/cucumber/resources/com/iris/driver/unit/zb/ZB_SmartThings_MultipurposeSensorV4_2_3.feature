@Zigbee @SmartThings @Contact @SmartThingsMPSV4
Feature: Test of the SmartThings Multipurpose Sensor V4 ZigBee driver

    These scenarios test the functionality of the SmartThings Multipurpose Sensor V4 ZigBee driver.

    Background:
        Given the ZB_SmartThings_MultipurposeSensorV4_2_3.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform.
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            ...
            And the message's devadv:drivername attribute should be ZBSmartThingsMultipurposeSensorV4
...
############################################################
    ...
    Examples:
      ...
      | 0x0020  | 0x00    | CLUSTER_POLL_CONTROL, CMD_RD_ATTR_RSP  |
