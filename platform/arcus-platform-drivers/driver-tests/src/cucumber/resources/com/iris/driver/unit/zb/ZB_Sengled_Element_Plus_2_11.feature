@Zigbee @Sengled @dimmer @bulb @element @plus
Feature: Test of the Sengled Element Plus Tunnable Bulb driver
    
    These scenarios test the functionality of the Sengled Element Plus Tunnable Bulb driver

Background:
    Given the ZB_Sengled_Element_Plus_2_11.driver has been initialized
...
Scenario: Driver reports capabilities to platform.
    ...
    Then the driver should place a base:GetAttributesResponse message on the platform bus
        And the message's base:caps attribute list should be ['base', 'dev', 'devadv', 'devconn', 'devpow', 'dim', 'swit', 'devota', 'light', 'colortemp', 'ident']
        And the message's dev:devtypehint attribute should be Light
        And the message's devadv:drivername attribute should be ZBSengledElementPlus 
