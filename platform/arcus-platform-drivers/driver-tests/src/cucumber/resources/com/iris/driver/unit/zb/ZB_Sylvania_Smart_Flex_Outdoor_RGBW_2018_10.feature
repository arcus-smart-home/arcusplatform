@Zigbee @Sylvania @Smart @bulb @FlexOutdoor @2018_10
Feature: Test of the Sylvania Smart+ Flex Outdoor RGBW Light Strip driver
    
    These scenarios test the functionality of the Sylvania Smart+ Flex Outdoor RGBW Light Strip driver.

    Background:
        Given the ZB_Sylvania_Smart_Flex_Outdoor_RGBW_2018_10.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform.
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            ...
            And the message's devadv:drivername attribute should be ZBSylvaniaSmartFlexOutdoorRGBWStrip 
