@ZWave @Jasco500 @Switch @PlugIn @Jasco14282
Feature: Unit Tests for the ZWave Plus Jasco 14282 PlugInSwitchDriver

	These scenarios test the functionality of the 500 Series ZWave PLus Jasco Plug-In Switch driver.

	Background:
		Given the ZW_Jasco_14282_PlugInSwitch_2_7.driver has been initialized
	...
	Scenario: Driver reports capabilities to platform. 
		...
		Then the driver should place a base:GetAttributesResponse message on the platform bus
			...
			And the message's devadv:drivername attribute should be ZWJasco14282SwitchDriver 
...
#Added becuase driver does this, should come out in next version
		Then the driver should send configuration set
			And with parameter param 3
			And with parameter size 1
			And with parameter val1 1
	...
	Scenario: Device reports state when first connected
		...
		Then the driver should place a base:ValueChange message on the platform bus
		Then the driver should poll switch_binary.get every 2 minutes
