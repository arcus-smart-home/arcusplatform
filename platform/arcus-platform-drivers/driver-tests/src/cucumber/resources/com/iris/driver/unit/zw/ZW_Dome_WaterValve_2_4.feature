@ZWave @watervalve @Dome
Feature: Test for ZWave water valve fom Dome

	These scenarios test the functionality of the Dome ZWave Water Valve Driver.

	Background:
		Given the ZW_Dome_WaterValve_2_4.driver has been initialized
	...
	Scenario: Driver reports capabilities to platform. 
		...
		Then the driver should place a base:GetAttributesResponse message on the platform bus
			...
			And the message's devadv:drivername attribute should be ZWDomeWaterValveDriver 
...
#does not get placed on the platform bus.
	...
	Scenario: Platform turns on valve via attribute change. 
		...
		Then the driver should schedule event DelayedRead in 12 seconds
