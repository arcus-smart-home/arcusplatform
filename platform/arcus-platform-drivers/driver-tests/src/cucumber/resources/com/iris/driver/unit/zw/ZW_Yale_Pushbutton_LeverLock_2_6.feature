@ZWave @Yale @lock @YRL210
Feature: ZWave Yale PushButton Level Lock Driver Test

    These scenarios test the functionality of the ZWave Yale PushButton Level Lock driver.

    Background:
        Given the ZW_Yale_Pushbutton_LeverLock_2_6.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform. 
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            ...
            And the message's devadv:drivername attribute should be ZWYalePushButtonLeverLock 
