...
Feature: ZWave Springs Roller Shade Test

    These scenarios test the functionality of the Springs Native ZWave Roller Shade driver.

    Background:
        Given the ZW_Springs_Roller_Shade.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform.
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            ...
            And the message's devadv:drivername attribute should be ZWSpringsRollerShadeDriver
