@Zigbee @DoorLock @Yale @Touchscreen @Deadbolt @YRD246
Feature: Test of the Yale Real Living 226/246 Touchscreen Deadbolt ZigBee driver

    These scenarios test the functionality of the Yale Real Living 226/246 Touchscree Deadbolt ZigBee driver.

    Background:
        Given the ZB_Yale_246_Touchscreen_Deadbolt_2_8.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform.
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            ...
            And the message's devadv:drivername attribute should be ZBYale246TouchscreenDeadbolt 
