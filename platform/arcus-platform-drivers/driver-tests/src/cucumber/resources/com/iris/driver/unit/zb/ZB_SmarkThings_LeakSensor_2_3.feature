@Zigbee @SmartThings @Leak
Feature: Test of the SmartThings Water Leak Sensor ZigBee driver

    These scenarios test the functionality of the SmartThings Water Leak Sensor ZigBee driver.

    Background:
        Given the ZB_SmartThings_LeakSensor_2_3.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform.
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            ...
            And the message's devadv:drivername attribute should be ZBSmartThingsLeakSensor 
