@ZWave @therm24 @Honeywell
Feature: ZWave Honeywell T6 Pro Thermostat Driver Test

	These scenarios test the functionality of the ZWave Honeywell T6 Pro Thermostat driver.

	Background:
		Given the ZW_Honeywell_T6Pro_Thermostat_2_4.driver has been initialized
...
############################################################
# Honeywell T6 Pro Thermostat Driver Specific Tests
#
# Notes:
