@ZWave @Zooz @tilt
Feature: ZWave Zooz ZSE43 Tilt / Shock XS Sensor Driver Test

These scenarios test the functionality of the ZWave Zooz ZSE43 Tilt / Shock XS Sensor driver

    Background:
    Given the ZW_Zooz_Zse43_TiltShockXsSensor.driver has been initialized
    ...
    Then the driver should place a base:GetAttributesResponse message on the platform bus
        ...
        And the message's devadv:drivername attribute should be ZWZoozZse43TiltShockXsSensorDriver
...
############################################################
# Notification Tests - Invalid Reports
############################################################

    @tilt @notification
    Scenario Outline: Device reports invalid notification that should not change state
        Given the capability tilt:tiltstate is <prev_state>
        When the device response with alarm report
            ...
            And send to driver
        Then the platform attribute tilt:tiltstate should be <prev_state>
