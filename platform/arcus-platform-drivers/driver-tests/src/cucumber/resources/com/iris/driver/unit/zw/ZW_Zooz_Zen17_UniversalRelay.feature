@ZWave @Zooz @switch
Feature: ZWave Zooz ZEN17 Universal Relay Driver Test

These scenarios test the functionality of the ZWave Zooz ZEN17 Universal Relay driver

    Background:
    Given the ZW_Zooz_Zen17_UniversalRelay.driver has been initialized
    ...
    Then the driver should place a base:GetAttributesResponse message on the platform bus
        ...
        And the message's devadv:drivername attribute should be ZWZoozZen17UniversalRelayDriver
