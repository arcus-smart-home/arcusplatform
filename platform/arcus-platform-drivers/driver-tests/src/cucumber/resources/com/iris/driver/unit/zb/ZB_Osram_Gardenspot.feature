@Zigbee @Osram @Gardenspot @dimmer @bulb
Feature: Test of the OSRAM Gardenspot driver
	
	These scenarios test the functionality of the OSRAM Gardenspot driver.

Background:
	Given the ZB_Osram_Gardenspot.driver has been initialized
...
Scenario: Driver reports capabilities to platform.
	...
	Then the driver should place a base:GetAttributesResponse message on the platform bus
		And the message's base:caps attribute list should be ['base', 'dev', 'devadv', 'devconn', 'devpow', 'dim', 'swit', 'devota', 'light', 'ident', 'color']
		And the message's dev:devtypehint attribute should be Light
		And the message's devadv:drivername attribute should be ZBOsramGardenspot 
