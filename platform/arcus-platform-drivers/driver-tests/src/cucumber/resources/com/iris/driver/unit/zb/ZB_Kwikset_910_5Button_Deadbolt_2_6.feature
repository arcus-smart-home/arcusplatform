@Zigbee @DoorLock @Kwikset @5Button @Deadbolt
Feature: Test of the Kwikset SmartCode 910 Push Button Deadbolt ZigBee driver

    These scenarios test the functionality of the Kwikset SmartCode 910 Push Button Deadbolt ZigBee driver.

    Background:
        Given the ZB_Kwikset_910_5Button_Deadbolt_2_6.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform.
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            ...
            And the message's devadv:drivername attribute should be ZBKwikset910Deadbolt 
