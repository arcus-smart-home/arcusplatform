@ZWave @Jasco500 @Dimmer @PlugIn @Jasco14280
Feature: Unit Tests Binary for the ZWave Plus Jasco  14280 DimmerDriver

    These scenarios test the functionality of the 500 series Jasco Plug-In Dimmer driver

    Background:
        Given the ZW_Jasco_14280_PlugInDimmer_2_7.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform. 
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            ...
            And the message's devadv:drivername attribute should be ZWJasco14280DimmerDriver
...
############################################################
    ...
    Scenario: Device reports state when first connected
        ...
        Then the driver should poll switch_multilevel.get every 2 minutes
...
############################################################
    ...
    Scenario Outline: Indicator value
        ...
        Examples:
          ...
          | ON    | true      |  false     |  50   | OFF      |
          | ON    | true      |  true      |  50   | ON       |
          | ON    | true      |  false     |   0   | ON       |
          | ON    | true      |  true      |   0   | OFF      |
#          | ON    | false     |  false     |  50   | DISABLED |
#          | ON    | false     |  true      |  50   | DISABLED |
