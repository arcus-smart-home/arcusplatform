@Zigbee @DoorLock @Kwikset @TouchScreen @Deadbolt
Feature: Test of the Kwikset SmartCode 916 Touchscreen Deadbolt ZigBee driver

    These scenarios test the functionality of the Kwikset SmartCode 916 Touchscreen Deadbolt ZigBee driver.

    Background:
        Given the ZB_Kwikset_916_Touchscreen_Deadbolt_2_6.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform.
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            And the message's base:caps attribute list should be [ 'base', 'dev', 'devadv', 'devconn', 'devpow', 'doorlock', 'temp', 'devota', 'ident' ]
            And the message's dev:devtypehint attribute should be Lock
            And the message's devadv:drivername attribute should be ZBKwikset916Deadbolt 
...
############################################################
    ...
    Scenario Outline: Power Read / Report
        ...
        When the device response with power <messageType> 
            ...
            And with parameter ATTR_BATTERY_VOLTAGE_MIN_THRESHOLD 40
            And send to driver
    ...
    Examples:
      ...
      | zclreadattributesresponse | 38      | 0       |
      | zclreadattributesresponse | 40      | 0       |
      | zclreportattributes       | 51      | 50      |
      | zclreportattributes       | 62      | 100     |
      | zclreportattributes       | 63      | 100     |
