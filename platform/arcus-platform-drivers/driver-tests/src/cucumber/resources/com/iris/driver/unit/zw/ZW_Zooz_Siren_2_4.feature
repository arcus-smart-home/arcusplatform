@ZWave @Zooz @siren
Feature: ZWave Zooz Siren Driver Test

These scenarios test the functionality of the ZWave Zooz Siren driver

    Background:
    Given the ZW_Zooz_Siren_2_4.driver has been initialized
    ...
    Then the driver should place a base:GetAttributesResponse message on the platform bus
        ...
        And the message's devadv:drivername attribute should be ZWZoozSirenDriver 
...
############################################################
# Zooz Siren Driver Specific Tests
############################################################
    ...
    Scenario: Make sure the offline timeout is set each time the device Connects
        ...
        Then the driver should set timeout at 190 minutes
            ...
            # config chime volume to LOW
            And the driver should send configuration set
                And with parameter param 4
                And with parameter size 1
                And with parameter val1 1
            # config chime sound to number 4
            And the driver should send configuration set
                And with parameter param 6
                And with parameter size 1
                And with parameter val1 4
