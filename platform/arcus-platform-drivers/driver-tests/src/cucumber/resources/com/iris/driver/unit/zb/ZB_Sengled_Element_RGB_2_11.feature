@Zigbee @Sengled @element @rgb
Feature: Test of the Sengled Element A19 RGB Bulb driver
    
    These scenarios test the functionality of the Sengled Element A19 RGB Bulb driver.

    Background:
        Given the ZB_Sengled_Element_RGB_2_11.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform.
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            ...
            And the message's devadv:drivername attribute should be ZBSengledElementRGB 
            ...
            And the message's colortemp:mincolortemp attribute should be 2000        
