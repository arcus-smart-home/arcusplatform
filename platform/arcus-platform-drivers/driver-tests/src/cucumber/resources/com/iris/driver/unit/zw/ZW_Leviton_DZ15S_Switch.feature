@ZWave @Leviton @Switch @DZ15S
Feature: Unit Tests for Leviton DZ15S ZWave Plus Switch

	These scenarios test the functionality of the Leviton switch driver.

	Background:
		Given the ZW_Leviton_DZ15S_InWallSwitch_2_9.driver has been initialized
	...
	Scenario: Driver reports capabilities to platform. 
		...
		Then the driver should place a base:GetAttributesResponse message on the platform bus
			...
			And the message's devadv:drivername attribute should be ZWLevitonDZ15SSwitch
