...
These scenarios test the functionality of the ZWave Plus GoCtrl Thermostat driver
	...
	Background:
	Given the ZW_GoCtrl_Thermostat500Series.driver has been initialized
...
##################################################################
	...
	Scenario Outline: Platform  sets thermostat capabilities
		...
		Then the driver should place a therm:setAttributesResponse message on the platform bus		
			And the driver should place a EmptyMessage message on the platform bus		
