@ZWave @Yale @lock @YRD246
Feature: ZWave Yale YRD226/246 PushButton Deadbolt Driver Test

    These scenarios test the functionality of the ZWave Yale YRD226/246 PushButton Deadbolt driver.

    Background:
        Given the ZW_Yale_246_Touchscreen_Deadbolt_2_8.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform. 
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            ...
            And the message's devadv:drivername attribute should be ZWYale246TouchScreenDeadbolt 
