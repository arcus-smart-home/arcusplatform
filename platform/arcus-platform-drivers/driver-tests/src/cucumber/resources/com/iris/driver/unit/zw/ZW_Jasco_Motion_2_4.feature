...
Feature: ZWave Jasco Motion Driver Test
	...
	Background:
		Given the ZW_Jasco_MotionSensor_2_4.driver has been initialized
...
@connected		 	
 	Scenario: Device connected
		...
		Then the driver should send configuration set
			...
			And with parameter size 1
			And with parameter val1 4
			#check if reflexes handle variable length payload properly.  They don't
#			And with parameter val2 null
