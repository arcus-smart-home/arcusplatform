@ZWave @Zooz @contact
Feature: ZWave Zooz Contact Sensor Driver Test

These scenarios test the functionality of the ZWave Zooz Contact Sensor driver

    Background:
    Given the ZW_Zooz_ContactSensor_2_4.driver has been initialized
    ...
    Then the driver should place a base:GetAttributesResponse message on the platform bus
        ...
        And the message's devadv:drivername attribute should be ZWZoozContactSensorDriver 
...
############################################################
# Zooz Contact Sensor Driver Specific Tests
############################################################
