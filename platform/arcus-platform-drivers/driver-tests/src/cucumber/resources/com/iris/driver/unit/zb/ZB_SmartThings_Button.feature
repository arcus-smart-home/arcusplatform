@Zigbee @SmartThings @Button
Feature: Test of the SmartThings Button ZigBee driver

    These scenarios test the functionality of the SmartThings Button ZigBee driver.

    Background:
        Given the ZB_SmartThings_Button.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform.
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            ...
            And the message's devadv:drivername attribute should be ZBSmartThingsButton
...
############################################################
    ...
    # Note: The reflex block handles IAS Zone messages and sets but:state,
    # but reflexes do not set but:statechanged (only platform-side handlers do).
    @IASZone
