@ZWave @Jasco500 @Dimmer @Jasco46203
Feature: Unit Tests for the ZWJasco46203DimmerDriver

    These scenarios test the functionality of the 500 series GE/Enbrighten 46203 In-Wall Paddle Dimmer driver

    Background:
        Given the ZW_Jasco_46203_InWallDimmer_2_4.driver has been initialized
