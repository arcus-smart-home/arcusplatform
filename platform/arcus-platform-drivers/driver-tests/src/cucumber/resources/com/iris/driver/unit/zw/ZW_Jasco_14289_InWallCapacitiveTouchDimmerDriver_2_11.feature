@ZWave @Jasco500 @Dimmer @Jasco14289
Feature: Unit Tests Binary for the ZWJasco14289InWallCapacitiveTouchDimmerDriver_2_11

    These scenarios test the functionality of the 500 series Jasco In-wall Capacitive Touch Dimmer driver

    Background:
        Given the ZW_Jasco_14289_InWallCapacitiveTouchDimmer_2_11.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform. 
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            ...
            And the message's devadv:drivername attribute should be ZWJasco14289CapacitiveTouchDimmerDriver
