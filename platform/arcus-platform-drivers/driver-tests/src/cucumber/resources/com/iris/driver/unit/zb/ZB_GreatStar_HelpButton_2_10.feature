@Zigbee @Greatstar @Help @Ignore
Feature: Test of the Greatstar Help Button ZigBee driver
    
    These scenarios test the functionality of the Greatstar Help Button ZigBee driver.

    Background:
        Given the ZB_Greatstar_HelpButton_2_10.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform.
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            ...
            And the message's devadv:drivername attribute should be ZBGreatstarHelpButton 
