...
Feature: Test of the CentraLite Contact Sensor ZigBee driver
    ...
    Background:
        Given the ZB_CentraLite_ContactSensor_2_3.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform.
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            ...
            And the message's devadv:drivername attribute should be ZBCentraLiteContactSensor 
