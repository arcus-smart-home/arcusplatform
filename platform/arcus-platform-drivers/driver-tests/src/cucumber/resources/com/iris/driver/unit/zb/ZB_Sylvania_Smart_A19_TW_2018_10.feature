@Zigbee @Sylvania @Smart @bulb @A19TW @2018_10
Feature: Test of the Sylvania Smart+ A19 Tuneable White Bulb driver
    
    These scenarios test the functionality of the Sylvania Smart+ A19 Tuneable White Bulb driver.

    Background:
        Given the ZB_Sylvania_Smart_A19_TW_2018_10.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform.
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            ...
            And the message's devadv:drivername attribute should be ZBSylvaniaSmartA19TWBulb 
