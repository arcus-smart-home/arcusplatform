@ZWave @Leviton @Dimmer @VRE06
Feature: Unit Tests Binary for the ZWave Dimmer

    These scenarios test the functionality of the ZWave Dimmer 

    Background:
        Given the ZW_Leviton_VRE06_InWallDimmer_2_9.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform. 
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            ...
            And the message's devadv:drivername attribute should be ZWLevitonVRE06Dimmer
