@ZWave @Enerwave @switch
Feature: ZWave Enerwave ZWN-RSM1-PLUS Smart Relay Switch Module Driver Test

These scenarios test the functionality of the ZWave Enerwave ZWN-RSM1-PLUS Smart Relay Switch Module driver

    Background:
    Given the ZW_Enerwave_ZWN_RSM1_PLUS_RelaySwitch.driver has been initialized
    ...
    Then the driver should place a base:GetAttributesResponse message on the platform bus
        ...
        And the message's devadv:drivername attribute should be ZWEnerwaveZWNRSM1PLUSRelaySwitch
