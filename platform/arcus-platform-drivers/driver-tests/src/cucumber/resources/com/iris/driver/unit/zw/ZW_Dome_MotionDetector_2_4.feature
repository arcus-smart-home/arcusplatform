@ZWave @Dome @motion
Feature: ZWave Dome Motion Detector and Illumination Sensor Driver Test

These scenarios test the functionality of the ZWave Dome Motion Detector and Illumination Sensor driver

    Background:
    Given the ZW_Dome_MotionDetector_2_4.driver has been initialized
    ...
    Then the driver should place a base:GetAttributesResponse message on the platform bus
        ...
        And the message's devadv:drivername attribute should be ZWDomeMotionDetectorDriver 
...
############################################################
# Dome Motion Detector & Illumination Sensor Driver Specific Tests
############################################################
