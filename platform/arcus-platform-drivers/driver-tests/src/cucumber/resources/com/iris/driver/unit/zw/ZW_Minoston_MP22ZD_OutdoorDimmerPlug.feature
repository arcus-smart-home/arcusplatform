@ZWave @Minoston @Dimmer @MP22ZD
Feature: Unit Tests for the ZWMinostonMP22ZDOutdoorDimmerPlugDriver

    These scenarios test the functionality of the Minoston MP22ZD Outdoor Dimmer Smart Plug driver

    Background:
        Given the ZW_Minoston_MP22ZD_OutdoorDimmerPlug.driver has been initialized
...
############################################################
# Multilevel Switch Report Tests
############################################################
