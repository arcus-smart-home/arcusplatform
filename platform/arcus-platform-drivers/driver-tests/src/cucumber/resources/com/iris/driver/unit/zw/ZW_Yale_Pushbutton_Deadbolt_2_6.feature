...
Feature: ZWave Yale PushButton Deadbolt Driver Test

	These scenarios test the functionality of the ZWave Yale PushButton Deadbolt driver.
	
	Background:
		Given the ZW_Yale_Pushbutton_Deadbolt_2_6.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform. 
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            ...
            And the message's devadv:drivername attribute should be ZWYalePushButtonDeadbolt 
