@ZWave @Generic @Fan
Feature: Unit Tests for Generic ZWave Fan Controller driver
  
    These scenarios test the functionality of the Generic Z-Wave Fan Controller driver.

    Background: 
        Given the ZW_ZZWaveGenericFanController_2_12.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform.
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            ...
            And the message's devadv:drivername attribute should be ZZWaveGenericFanController
