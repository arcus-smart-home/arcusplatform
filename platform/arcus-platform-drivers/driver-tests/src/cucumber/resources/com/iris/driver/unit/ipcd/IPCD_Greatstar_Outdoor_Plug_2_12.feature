@IPCD @GreatStar
Feature: IPCD GreatStar Outdoor Plug Driver Test

	These scenarios test the functionality of the IPCD GreatStar Outdoor Plug driver.
	
	Background:
		Given the IPCD_GreatStar_Outdoor_Plug_2_12.driver has been initialized
    ...
    Then the driver should place a base:GetAttributesResponse message on the platform bus
	    ...
	    And the message's devadv:drivername attribute should be IPCDGreatStarOutdoorPlug
