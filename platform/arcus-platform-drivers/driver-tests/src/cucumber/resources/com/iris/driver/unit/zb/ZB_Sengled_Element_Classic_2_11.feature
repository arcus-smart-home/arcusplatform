@Zigbee @Sengled @dimmer @bulb @element @classic
Feature: Test of the Sengled Element Classic Dimmable Bulb driver
    
    These scenarios test the functionality of the Sengled Element Classic Dimmable Bulb driver used for both the A19 and BR30

Background:
    Given the ZB_Sengled_Element_Classic_2_11.driver has been initialized
...
Scenario: Driver reports capabilities to platform.
    ...
    Then the driver should place a base:GetAttributesResponse message on the platform bus
        ...
        And the message's devadv:drivername attribute should be ZBSengledElementClassic 
