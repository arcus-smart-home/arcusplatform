@Zigbee @Sylvania @Smart @bulb @PAR38OOD @2018_10
Feature: Test of the Sylvania Smart+ PAR38 On/Off/Dimmer White Bulb driver
    
    These scenarios test the functionality of the Sylvania Smart+ PAR38 On/Off/Dimmer Bulb driver.

    Background:
        Given the ZB_Sylvania_Smart_PAR38_OOD_2018_10.driver has been initialized
    ...
    Scenario: Driver reports capabilities to platform.
        ...
        Then the driver should place a base:GetAttributesResponse message on the platform bus
            ...
            And the message's devadv:drivername attribute should be ZBSylvaniaSmartPAR38DimBulb 
...
############################################################
    ...
    Scenario Outline: default ZigbeeMessage processing
        ...
        Examples:
          ...
          | 0x0B05  | 0x07    | CLUSTER_COLOR_CONTROL, CMD_CNFG_RPT_RSP |
