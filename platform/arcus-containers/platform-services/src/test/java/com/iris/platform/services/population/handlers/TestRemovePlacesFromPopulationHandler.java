...
public class TestRemovePlacesFromPopulationHandler extends IrisMockTestCase {
   ...
   // unit under test
   @Inject
   private RemovePlacesFromPopulationHandler handler;
   ...
   @Test
   public void testRemovePlacesSuccess() throws Exception {      
      ...
      assertNull(place1.getPopulation());
      assertNull(place2.getPopulation());
      verify();
   }
   
   @Test
   public void testRemovePlacesSuccessUpdateOne() throws Exception {      
      place1.setPopulation(population.getName());
      place2.setPopulation("fakePopulation");  //existing population does not match
      ...
      assertEquals(MessageBody.emptyMessage(), response);
      assertNull(place1.getPopulation());
      assertNotNull(place2.getPopulation());  //place2 should not be updated because the original population id does not match
      verify();
   }
   
   @Test
   public void testRemovePlacesSuccess2() throws Exception {      
   ...
   @Test
   public void testRemovePlacesSuccess3() throws Exception {      
   ...
   @Test
   public void testRemovePlacesPopulationContextDoesNotMatch() throws Exception {      
   ...
   @Test
   public void testRemovePlacesInvalidPopulation() throws Exception {      
   ...
   @Test
   public void testRemovePlacesMissingPopulation() throws Exception {
      replay();
   ...
   @Test
   public void testRemovePlacesMissingPlaces() throws Exception {
      EasyMock.expect(populationDao.findByName(population.getName())).andReturn(population);
      replay();
   ...
   private void setupMocksForSuccess(boolean needLookupPopulation) {
      place1.setPopulation(population.getName());
      place2.setPopulation(population.getName());
