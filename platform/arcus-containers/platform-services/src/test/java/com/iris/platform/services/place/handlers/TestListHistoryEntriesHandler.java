 ...
 * 
 */
public class TestListHistoryEntriesHandler extends ListHistoryEntriesHandlerTestCase<Place> {
   ...
   protected MessageBody createListRequest(Place context, Integer limit, String token) {
      return 
            PlaceCapability.ListHistoryEntriesRequest
               .builder()
               .withLimit(limit)
               .withToken(token)
               .build();
   ...
   protected HistoryLogEntryType getType() {
      return HistoryLogEntryType.DETAILED_PLACE_LOG;
   }
