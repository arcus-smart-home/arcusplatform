...
public class GetProductsByBrandHandler extends AbstractProductCatalogHandler {
   private final BeanListTransformer<ProductCatalogEntry> listTransformer;

   @Inject
   public GetProductsByBrandHandler(BeanAttributesTransformer<ProductCatalogEntry> transformer,
   ...
   public String getMessageType() {
      return ProductCatalogCapability.GetProductsByBrandRequest.NAME;
   }
   ...
   public MessageBody handleRequest(ProductCatalog context, PlatformMessage msg) {
      ...
      String brandName = ProductCatalogCapability.GetProductsByBrandRequest.getBrand(request);
      List<ProductCatalogEntry> entries = context.getProductsByBrand(brandName);
      List<Map<String, Object>> products = listTransformer.convertListToAttributes(entries);
      return ProductCatalogCapability.GetProductsByBrandResponse.builder()
