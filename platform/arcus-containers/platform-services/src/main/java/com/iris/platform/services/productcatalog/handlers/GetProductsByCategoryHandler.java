...
public class GetProductsByCategoryHandler extends AbstractProductCatalogHandler {
   private final BeanListTransformer<ProductCatalogEntry> listTransformer;

   @Inject
   public GetProductsByCategoryHandler(BeanAttributesTransformer<ProductCatalogEntry> transformer,
   ...
   public String getMessageType() {
      return ProductCatalogCapability.GetProductsByCategoryRequest.NAME;
   }
   ...
   public MessageBody handleRequest(ProductCatalog context, PlatformMessage msg) {
      ...
      String category = ProductCatalogCapability.GetProductsByCategoryRequest.getCategory(request);
      List<ProductCatalogEntry> entries = context.getProductsByCategory(category);
      List<Map<String, Object>> products = listTransformer.convertListToAttributes(entries);
      return ProductCatalogCapability.GetProductsByCategoryResponse.builder()
