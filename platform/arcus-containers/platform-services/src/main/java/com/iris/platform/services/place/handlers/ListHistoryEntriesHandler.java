...
import com.iris.messages.capability.PlaceCapability.ListHistoryEntriesRequest;
import com.iris.messages.capability.PlaceCapability.ListHistoryEntriesResponse;
...
public class ListHistoryEntriesHandler implements ContextualRequestMessageHandler<Place> {
   ...
   public MessageBody handleRequest(Place context, PlatformMessage msg) {
      Utils.assertNotNull(context, "Place is required to list history log entries");
