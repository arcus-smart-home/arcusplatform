...
public class GetProductsHandler extends AbstractProductCatalogHandler {
   ...
   public String getMessageType() {
      return ProductCatalogCapability.GetProductsRequest.NAME;
   }
   ...
   public MessageBody handleRequest(ProductCatalog context, PlatformMessage msg) {
      ...
      List<ProductCatalogEntry> entries = context.getProducts();
      List<Map<String, Object>> products = listTransformer.convertListToAttributes(entries);
      return ProductCatalogCapability.GetProductsResponse.builder()
