...
@Singleton
public class MobileDeviceGetAttributesHandler extends AbstractGetAttributesPlatformMessageHandler<MobileDevice> {

   @Inject
   public MobileDeviceGetAttributesHandler(BeanAttributesTransformer<MobileDevice> mobileDeviceTransformer) {
      super(mobileDeviceTransformer);
   }
