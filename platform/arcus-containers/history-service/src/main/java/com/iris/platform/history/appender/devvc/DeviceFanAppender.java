...
import static com.iris.messages.capability.FanCapability.ATTR_SPEED;
...
@AutoTranslate()
@AnyValue(attr=ATTR_SPEED, tpl="device.fan.speed", critical=true)
@Values({ValueGetter.ATTR_VALUE})
public class DeviceFanAppender extends AnnotatedDeviceValueChangeAppender {
	
	@Inject
	public DeviceFanAppender(HistoryAppenderDAO appender, ObjectNameCache cache) {
