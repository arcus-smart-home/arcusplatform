...
import static com.iris.messages.capability.WaterSoftenerCapability.ATTR_RECHARGESTATUS;
import static com.iris.messages.capability.WaterSoftenerCapability.RECHARGESTATUS_RECHARGING;
...
@AutoTranslate()
@EnumValue(attr=ATTR_RECHARGESTATUS, val=RECHARGESTATUS_RECHARGING, tpl="device.watersoftener.recharging", critical=true)
public class DeviceWaterSoftenerAppender extends AnnotatedDeviceValueChangeAppender {
	
	@Inject
	public DeviceWaterSoftenerAppender(HistoryAppenderDAO appender, ObjectNameCache cache) {
