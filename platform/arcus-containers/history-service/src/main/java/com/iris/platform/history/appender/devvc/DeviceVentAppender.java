...
import static com.iris.messages.capability.VentCapability.ATTR_LEVEL;
import static com.iris.messages.capability.VentCapability.ATTR_VENTSTATE;
import static com.iris.messages.capability.VentCapability.VENTSTATE_OBSTRUCTION;
...
@AutoTranslate
@AnyValue(attr = ATTR_LEVEL, tpl = "device.vent.level", critical = true)
@Values(ValueGetter.ATTR_VALUE)
@EnumValue(attr = ATTR_VENTSTATE, val = VENTSTATE_OBSTRUCTION, tpl = "device.vent.obstruction", critical = true)
public class DeviceVentAppender extends AnnotatedDeviceValueChangeAppender {

   @Inject
   public DeviceVentAppender(HistoryAppenderDAO appender, ObjectNameCache cache) {
