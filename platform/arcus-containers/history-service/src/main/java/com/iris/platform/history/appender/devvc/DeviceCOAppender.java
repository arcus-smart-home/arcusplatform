...
@AutoTranslate()
@EnumValue(attr=CarbonMonoxideCapability.ATTR_CO, val=CarbonMonoxideCapability.CO_DETECTED, tpl="device.co.detected", critical=true)
@EnumValue(attr=CarbonMonoxideCapability.ATTR_CO, val=CarbonMonoxideCapability.CO_SAFE,     tpl="device.co.none",     critical=false)
public class DeviceCOAppender extends AnnotatedDeviceValueChangeAppender {

	@Inject
	protected DeviceCOAppender(HistoryAppenderDAO appender, ObjectNameCache cache) {
