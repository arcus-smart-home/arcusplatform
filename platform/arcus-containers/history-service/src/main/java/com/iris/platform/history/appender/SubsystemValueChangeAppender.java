 ...
 * 
 */
public abstract class SubsystemValueChangeAppender extends BaseHistoryAppender {

   protected Matcher matcher;
   protected Translator translator;
   
   protected SubsystemValueChangeAppender(HistoryAppenderDAO appender, ObjectNameCache cache, Matcher matcher, Translator translator) {
   ...
   protected MatchResults matches(PlatformMessage message) {
      boolean match = 
            ((String)message.getSource().getGroup()).startsWith("sub") &&
