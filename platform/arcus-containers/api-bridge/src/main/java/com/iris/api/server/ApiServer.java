...
import com.iris.api.server.session.ApiBridgeSecurityModule;
...
public class ApiServer extends BridgeServer {

   @Inject
   public ApiServer(ServerRunner runner) {
      super(runner);
   }
   ...
   public static void main(String... args) {
      ...
      IrisAbstractApplication.exec(ApiServer.class, modules, args);
   }
}
