...
import com.iris.api.server.auth.ApiKeyRealm;
...
public class ApiBridgeSecurityModule extends PersonDAOSecurityModule {

   @Inject
   public ApiBridgeSecurityModule(SessionConfig config) {
      super(config);
   }

   @Override
   protected void bindSessionManager(AnnotatedBindingBuilder<SessionManager> bind) {
      Multibinder<SessionListener> shiroSessionListeners = Multibinder.newSetBinder(
            binder(), SessionListener.class, Names.named(GuicySessionManager.PROP_SESSION_LISTENERS));
