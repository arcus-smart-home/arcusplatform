...
@Singleton
public class GoogleWhitelist {

   private final boolean whitelistEnabed;
   ...
   public boolean isWhitelisted(UUID placeId) {
      return isWhitelisted(placeId.toString());
   }

   public boolean isWhitelisted(String placeId) {
      boolean whitelisted = true;
      if(whitelistEnabed) {
         whitelisted = whiteList.contains(placeId);
      }
      return whitelisted;
   }
}
