...
class RequestHandler {
   ...
   @Request(value = MessageConstants.MSG_ANY_MESSAGE_TYPE, service = true, response = false)
   public void onRequest(VoiceContextExecutor executor, PlatformMessage message) {
