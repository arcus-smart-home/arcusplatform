...
public class TestDirectiveTransformerIncrementTargetTemperatureV2 {
   ...
   public void testIncrement() {
      ...
      assertEquals(ThermostatCapability.IncrementIdealTemperatureRequest.NAME, body.getMessageType());
      assertEquals(2.00, ThermostatCapability.IncrementIdealTemperatureRequest.getAmount(body).doubleValue(), .01);
   }
   ...
   private AlexaService.ExecuteRequest.Builder builder() {
      return AlexaService.ExecuteRequest.builder()
         .withDirective("IncrementTargetTemperatureRequest");
   }
