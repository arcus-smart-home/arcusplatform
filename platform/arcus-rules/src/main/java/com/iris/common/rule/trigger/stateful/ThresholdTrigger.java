...
public class ThresholdTrigger extends StatefulCondition {
   ...
   private class ActiveState implements State {
      public final static String NAME="ACTIVE";
      private final static String VAR_FIRING="_activeStateFiring";
      ...
      @Override
      public boolean isFiring(RuleContext context) {
    	  Boolean firing = context.getVariable(VAR_FIRING, Boolean.class);
    	  if (firing==null || !firing) { 
      ...
      public void onExit(RuleContext context) {
          ...
          context.setVariable(VAR_FIRING, null);
      }
