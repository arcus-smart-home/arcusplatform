 ...
 */
public class AttributeValueChangedEvent extends RuleEvent {
   private final Address address;
   private final String attributeName;
   private final Object attributeValue;
   private final Object oldValue;
   
   public static AttributeValueChangedEvent create(
         Address address,
         String attributeName,
         Object attributeValue,
         Object oldValue
   ) {
      return new AttributeValueChangedEvent(address, attributeName, attributeValue, oldValue);
   }
   
   private AttributeValueChangedEvent(
         Address address,
         String attributeName,
         Object attributeValue,
         Object oldValue
   ...
   public RuleEventType getType() {
      return RuleEventType.ATTRIBUTE_VALUE_CHANGED;
   }
   ...
   public boolean equals(Object obj) {
      ...
      AttributeValueChangedEvent other = (AttributeValueChangedEvent) obj;
      if (address == null) {
