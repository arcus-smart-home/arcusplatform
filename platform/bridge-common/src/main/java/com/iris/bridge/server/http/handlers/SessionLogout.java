...
@Singleton
@HttpPost("/logout")
public class SessionLogout extends RequestHandlerImpl {

   @Inject
   public SessionLogout(AlwaysAllow alwaysAllow, @Named("SessionLogout") Responder logoutResponder) {
      super(alwaysAllow, logoutResponder);
   }
