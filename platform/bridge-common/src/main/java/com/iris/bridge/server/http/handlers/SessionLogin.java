...
@HttpPost("/login")
@HttpPost("/")
public class SessionLogin extends RequestHandlerImpl {

   @Inject
   public SessionLogin(AlwaysAllow alwaysAllow, @Named("SessionLogin") Responder loginResponder) {
      super(alwaysAllow, loginResponder);
   }
