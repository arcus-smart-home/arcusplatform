...
@Singleton
public class WebSocketServerHandlerProvider implements Provider<WebSocketServerHandler> {
   ...
   @Inject
   public WebSocketServerHandlerProvider(
   ...
   @Override
   public WebSocketServerHandler get() {
