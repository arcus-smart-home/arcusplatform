...
public class KeypadBinder extends AddressesAttributeBinder<SecuritySubsystemModel> {

	public KeypadBinder() {
		super(Predicates.isA(KeyPadCapability.NAMESPACE), SecuritySubsystemCapability.ATTR_KEYPADS);
	}
