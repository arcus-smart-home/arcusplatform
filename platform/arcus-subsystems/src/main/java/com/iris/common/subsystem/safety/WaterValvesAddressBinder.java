...
public class WaterValvesAddressBinder extends AddressesAttributeBinder<SafetySubsystemModel> {
	
	public WaterValvesAddressBinder() {
		super(
				Predicates.isA(ValveCapability.NAMESPACE), 
      		SafetySubsystemCapability.ATTR_WATERSHUTOFFVALVES
      );
	}
